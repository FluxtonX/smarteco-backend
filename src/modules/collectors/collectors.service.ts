...
export class CollectorsService {
    ...
    async updatePickupStatus(
        ...
        if (dto.status === 'COMPLETED') {
            ...
            const tier = userTotalPoints >= 5000 ? 'ECO_CHAMPION' : userTotalPoints >= 1000 ? 'ECO_WARRIOR' : 'ECO_STARTER';
            const multiplier = tier === 'ECO_CHAMPION' ? 1.5 : tier === 'ECO_WARRIOR' ? 1.25 : 1.0;
