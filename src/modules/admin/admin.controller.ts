...
export class AdminController {
    ...
    @ApiOperation({
        ...
        description: 'Get paginated list of all pickups with user and collector info. Admin only.',
    })
    ...
    @ApiOperation({
        ...
        description: 'Get list of all registered collectors with performance stats. Admin only.',
    })
