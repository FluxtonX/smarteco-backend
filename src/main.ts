...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    .setTitle('SmartEco AI API')
    .setDescription(
      `
## Smart Waste Management Platform API

SmartEco AI enables residents and businesses in Rwanda to:
...
- **ADMIN** — Full access to all data, analytics, and user management.
  ...
  SwaggerModule.setup(SWAGGER_PATH, app, document, {
    customSiteTitle: 'SmartEco AI API Docs',
    customCss: `
  ...
  logger.log(`🚀 SmartEco AI API running on http://localhost:${port}`);
  logger.log(
